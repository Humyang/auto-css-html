<template>
  <div class="scq-view flex column" style="height: 100%;">
    ...
    <div class="flex row">
      <div
        style="width: 50%;height:100%;overflow:auto;margin-right:10px;"
        class="flex column"
      >
        ...
        <el-tabs type="border-card">
            ...
            <div class="flex column content" style="text-align: left;">
              ...
              <div class="insersub-view flex column" style="margin-left:20px;">
                <div>
                  <el-select
                    placeholder="设置添加位置"
                    v-model="appendPosition"
                  >
                    <el-option
                      label="子级添加"
                      value="subChildAppend"
                    ></el-option>
                    <el-option
                      label="孙级添加"
                      value="subChildInsert"
                    ></el-option>
                  </el-select>
                </div>
                <div class="flex row">
                  <div class="row-list">
                    <div class="subitem flex vcenter" @click="rowAdd(0)">
                      ROW
                    </div>
                    <div
                  ...
                  <div class="column-list">
                    <div class="subitem flex vcenter" @click="columnAdd(0)">
                      COLUMN
                    </div>
                    <div
                      class="subitem flex vcenter"
          ...
          <el-tab-pane label="原生属性">
            <div style="    text-align: left;">
              <el-tabs type="border-card">
                <el-tab-pane label="CSS属性">
                  <css-declaration />
                </el-tab-pane>
                <el-tab-pane label="HTML属性">
